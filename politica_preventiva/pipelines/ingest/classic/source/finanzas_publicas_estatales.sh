...
curl http://www.beta.inegi.org.mx/contenidos/proyectos/registros/economicas/finanzas/datosabiertos/efipem_estatal_csv.zip > $local_path/finanzas_publicas_$year.zip
