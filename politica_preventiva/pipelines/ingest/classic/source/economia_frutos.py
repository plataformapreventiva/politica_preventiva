...
def ingest_frutos(start_date, end_date='', output='', mercado=''):
    """
    ...
    for year, month, central in product(anios, meses, centrales_dict.keys()):
        ...
        if (month < end_month or year < end_year) and (
                month >= start_month or year > start_year) and central == mercado:
            print(
            'Retrieving year={}, month={}, tipo={}, central={}'.format(year, month, tipo, centrales_dict[central]))
            ...
            try:
                ...
                print('Connection error: year={}, month={}, tipo={}, central={}'.format(year, month, tipo,
                                                                                        centrales_dict[central]))
                response = False
            ...
            if response:
                ...
                logging.info(
                    'Connection timeout: year={}, month={}, tipo={}, central={}'.format(year, month, tipo, central))
                print('**Connection timeout**: year={}, month={}, tipo={}, central={}'.format(year, month, tipo,
                                                                                              centrales_dict[central]))
